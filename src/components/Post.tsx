    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Image
            src="https://images.pexels.com/photos/26796134/pexels-photo-26796134.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
            alt=""
            width={40}
            height={40}
      ...
      <div className="flex flex-col gap-4">
        <div className="w-full min-h-96 relative">
          <Image
            src="https://images.pexels.com/photos/27086057/pexels-photo-27086057.jpeg?auto=compress&cs=tinysrgb&w=800&lazy=load
            "
            alt=""
            fill
